...
- [Support Library](http://developer.android.com/intl/zh-cn/tools/support-library/index.html)
- [Material Design介绍](http://design.1sters.com/)
-  [Design Support Library完全使用实例](http://www.open-open.com/lib/view/open1433385856119.html)
...
* [你必须了解的RecyclerView的五大开源项目-解决上拉加载、下拉刷新和添加Header和Footer](http://blog.csdn.net/mynameishuangshuai/article/details/51153978)
...
- [Drag and Swipe with RecyclerView Part One: Basic ItemTouchHelper Example](https://medium.com/@ipaulpro/drag-and-swipe-with-recyclerview-b9456d2b1aaf#.x3kjz34vf)
- [Drag and Swipe with RecyclerView Part Two: Handles, Grids, and Custom Animations](https://medium.com/@ipaulpro/drag-and-swipe-with-recyclerview-6a6f0c422efd#.p3pegny2x)
- [RecyclerView使用详解](http://blog.cgsdream.org/2015/06/11/recyclerview/)
...
- [RecyclerView使用详解（三）CursorAdapter;嵌套RecyclerView](http://frank-zhu.github.io/android/2015/02/26/android-recyclerview-part-3/)
- [DividerItemDecorationu](https://gist.github.com/alexfu/0f464fc3742f134ccd1e)
- [ItemDecoration:详细介绍了ItemDecoration的使用](http://willclub.me/android/2015/04/24/recyclerview3/)
- [ RecyclerView的高级用法——定制动画](http://blog.csdn.net/qibin0506/article/details/47250299)
...
- [RecyclerView made simple.twoway-view RecyclerView made simple.](https://github.com/lucasr/twoway-view)
- [UltimateRecyclerView](https://github.com/cymcsg/UltimateRecyclerView)


### DrawerLayout

* [DrawerLayout](http://developer.android.com/intl/zh-cn/reference/android/support/v4/widget/DrawerLayout.html)
* [Creating a Navigation Drawer](http://developer.android.com/intl/zh-cn/training/implementing-navigation/nav-drawer.html)
* [Android组件——使用DrawerLayout仿网易新闻v4.4侧滑菜单](http://blog.csdn.net/allen315410/article/details/42914501)
* [如何使用Toolbar(Actionbar)+DrawerLayout](http://givemepass-blog.logdown.com/posts/292008-how-to-use-the-toolbar)
* [DrawerLayout(官方侧滑菜单)的简单使用](http://www.runoob.com/w3cnote/android-tutorial-drawerlayout.html)
...
- [Switch介绍](http://www.runoob.com/w3cnote/android-tutorial-togglebutton-switch.html)
